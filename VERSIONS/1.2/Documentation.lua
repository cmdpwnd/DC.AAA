...
--[[Setup
    ...
    [[Procedure
        place disk drives to be accessed via network or adjacent
        place wired modem on disk drives and on computer
        connect disk drives and computer with networking cable
        right click wired modems on disk drives and computer to connect them to network

        configure database
        place disk drive adjacent to computer

        [Repeat per user
            insert floppy disk into adjacent disk drive
            run createFloppy.lua
        ]
...
--[[Configuration Guide
    [[Log:
        ...
        Format: timestamp: user @ drive: boolean
            [
                user = diskLabel,
    ...
    [[Debug:
        Configuration variable: _debugPath
            default: _debugPath = '/debug.dc'

            stores process information on a user's attempt to authenticate to a drive
        ...
        allows administrator to view process information on a user's attempt to authenticate to a drive via live screen output
        Format: timestamp: msg
    ]]
    [[Console:
